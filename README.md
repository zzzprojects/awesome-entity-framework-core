...
Please take a quick gander at the [contribution guidelines](https://github.com/zzzprojects/awesome-entity-framework-core/blob/master/CONTRIBUTING.md) first.
...
## Supported Packages
 ...
 - [Arragro.Core.EntityFrameworkCore](https://github.com/Arragro/Arragro.Core) - Core EFCore library for Arragro for Repository functionality and BaseContext.
 ...
 - [MiniProfiler.EntityFrameworkCore](https://miniprofiler.com/) - MiniProfiler: Integration for Entity Framework Core.
 - [Ralms.EntityFrameworkCore.Extensions](https://github.com/ralmsdeveloper/Ralms.EntityFrameworkCore.Extensions) - Extensions for EntityFramework Core.
 - [DotNetToolkit.Repository.EntityFrameworkCore](https://github.com/johelvisguzman/DotNetToolkit.Repository) - A toolkit that provides a lightweight starter kit for using the Repository pattern for the Entity Framework Core.
 - [Remote.Linq.EntityFrameworkCore](https://github.com/6bee/Remote.Linq) - Remote linq extensions for entity framework core. 
 - [Riganti.Utils.Infrastructure.EntityFrameworkCore](https://github.com/riganti/infrastructure) - Riganti.Utils.Infrastructure is an implementation of common enterprise architecture design patterns. This library can be used as a foundation of a business layer in your application.
 - [CSLA-EntityFrameworkCore](https://github.com/MarimerLLC/csla) - CSLA .NET is an application development framework that reduces the cost of building and maintaining applications. 
 - [EntityFrameworkCore.BootKit](https://github.com/Oceania2018/EntityFrameworkCore.BootKit) - EntityFrameworkCore Boot Kit (EFBK) is a quick start database connect library for using .NET EntityFrameworkCore.
 - [NeinLinq.EntityFrameworkCore](https://github.com/axelheer/nein-linq) - NeinLinq provides helpful extensions for using LINQ providers such as Entity Framework.
 - [Nofy.EntityFrameworkCore](https://github.com/unops/nofy) - Nofy is a very simple .NET Standard library to help you manage notifications inside your app.
 - [Intent.Framework.EntityFrameworkCore](https://intentarchitect.com/) - Library for EntityFrameworkCore to support ambient DbContexts.
 - [linq2db.EntityFrameworkCore](https://www.nuget.org/packages/linq2db.EntityFrameworkCore) - Allows executing Linq to DB (linq2db) queries in Entity Framework Core DbContext.
 ...
 - [Stove.EntityFrameworkCore](https://github.com/osoykan/Stove) - Stove is an application framework that wraps and abstracts your needs for easy use. Built with strongly adopted dependency injection principles.
 - [EntityFrameworkCore.Triggers](https://github.com/NickStrupat/EntityFramework.Triggers) - Add triggers to your entities with insert, update, and delete events. There are three events for each: before, after, and upon failure.
 - [EntityFrameworkCore.TypedOriginalValues](https://github.com/NickStrupat/EntityFramework.TypedOriginalValues) - Get typed access to the OriginalValues of your entity properties. Simple and complex properties are supported, navigation/collections are not.
 - [ErikEJ.EntityFrameworkCore.DgmlBuilder](https://github.com/ErikEJ/SqlCeToolbox) - Generate DGML (Graph) content that visualizes your DbContext. Adds the AsDgml() extension method to the DbContext class. Also has AsSqlScript() extension method to generate a SQL script for your current model.
 - [EntityFrameworkCore.Diagrams](https://db-diagrams.firebaseapp.com/) - Visualize model created with EntityFramework Core in ASP.NET Core app.
 - [FlexLabs.Upsert](https://github.com/artiomchi/FlexLabs.Upsert) - Adds basic support for "Upsert" operations to EF Core.
 - [Microsoft.EntityFrameworkCore.LazyLoading](https://github.com/darxis/EntityFramework.LazyLoading) - This package enables LazyLoading for EntityFramework Core.
 ...
 - [Moq.EntityFrameworkCore](https://github.com/MichalJankowskii/Moq.EntityFrameworkCore) - Library that provides methods that will help you with mocking EntityFrameworkCore.
 ...
 - [Scalider.EntityFrameworkCore](https://github.com/wilsonrivera/scalider-v2) - Uses Entity Framework Core to provide a Unit of Work and Repository layer.
 ...
 - [Microsoft.EntityFrameworkCore.DynamicLinq](https://github.com/StefH/System.Linq.Dynamic.Core) - Dynamic Linq extensions for Microsoft.EntityFrameworkCore which adds Async support.
 ...
 - [Communist.EntityFrameworkCore](https://github.com/bsheldrick/communist) - Entity Framework Core extensions and helpers for Communist service layer library.
 - [MassTransit.EntityFrameworkCore](https://github.com/MassTransit/MassTransit) - MassTransit Entity Framework Core support; MassTransit is a message-based distributed application framework for .NET
 - [OpenIddict.EntityFrameworkCore.Models](https://github.com/openiddict/openiddict-core) - Relational entities for the Entity Framework Core stores.
 - [EfCore.Shaman](https://github.com/isukces/EfCore.Shaman) - EfCore.Shaman offers simple solution for some of problems. For more information please visit [http://efcoreshaman.com/](http://efcoreshaman.com/).
 - [Filer.EntityFrameworkCore](https://github.com/UNOPS/filer) - Filer is a very simple .NET Standard library to help you manage documents inside your app. This package includes implementation of SQL Store.
 ...
 - [MiniProfiler.EntityFrameworkCore](https://github.com/MiniProfiler/dotnet) - MiniProfiler for Entity Framework Core
 ...
 - [LinqKit.Microsoft.EntityFrameworkCore](https://github.com/scottksmith95/LINQKit) - LinqKit.Microsoft.EntityFrameworkCore is a free set of extensions for LINQ to SQL and EntityFrameworkCore power users. With Include(...) and IDbAsync support.
 - [EFCore.BulkExtensions](https://github.com/borisdj/EFCore.BulkExtensions) - EntityFramework EF Core Bulk Extensions for Insert Update and Delete (CUD) operations on SQL Server.
 ...
 - [EFCore.DbContextFactory ](https://github.com/vany0114/EF.DbContextFactory) - With EF.DbContextFactory you can resolve easily your DbContext dependencies in a safe way injecting a factory instead of an instance itself.
 - [Cake.DotNetCoreEf](https://github.com/cake-contrib/Cake.DotNetCoreEfCake) - Build addin for using the .NET Core EntityFrameworkCore command line interface (CLI)
 - [InfoCarrier.Core](https://github.com/azabluda/InfoCarrier.Core) - EntityFrameworkCore provider for multitier applications
 - [Configuration.EntityFramework](https://github.com/thinkabouthub/Configuration.EntityFramework) - Configuration.EntityFramework is a custom configuration provider for the .NET Core Configuration system. It's built on EntityFrameworkCore allowing configuration settings to be stored in a wide variety of repositories
 - [MockQueryable.Core](https://github.com/romantitov/MockQueryable) - Async operations with generic collections, to provide for collections such List<T> execute EntityFrameworkCore operations such ToListAsync, FirstOrDefaultAsync etc.
 ...
 - [Impatient.EntityFrameworkCore.SqlServer](https://github.com/tuespetre/Impatient) - An alternative query compiler for Microsoft.EntityFrameworkCore.SqlServer that supports complex queries and operators and FOR JSON. 
 - [EntityFrameworkCorePluralize](https://github.com/Apeoholic/EntityFrameworkCorePluralize) - A package that makes it simple to create plural och singular models with Entity Framework Core.
 ...
 - [Extensions.EntityFrameworkCore.SqlServer.Bulk]() - Extensions for EntityFramework Core to use SqlServers SqlBulkCopy in order to provide high performance Insert, Update and Delete mass operations.
 - [Arragro.EntityFrameworkCore](https://github.com/Arragro/Arragro) - Core EFCore library for Arragro for Repository functionality and BaseContext.
